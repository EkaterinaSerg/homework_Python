...
frac1_str = input('Введите а/b: ')
frac2_str = input('Введите а/b: ')
...
x1 = Fraction(frac1_str)
x2 = Fraction(frac2_str)
print(f"Сумма дробей {x1} и {x2} = {x1 + x2}")
print(f"Произведение дробей {x1} и {x2} = {x1 * x2}")